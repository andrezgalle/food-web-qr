...
const CardInformation = ({titulo,direccion,telefonos,apertura,cierre,url}) => {
  return (
    <div className='card-information overflow-hidden'>
        ...
        <div className='texto-card-information-div'>
            ...
            <p className='flex gap-2 items-center mb-2 text-sm font-bold'>Horarios de Apertura: <span className='font-normal'>{apertura}</span><img src={time} className='w-6 inline-block' alt=""/></p>
            <p className='flex gap-2 items-center mb-2 text-sm font-bold'>Horarios de Cierre: <span className='font-normal'>{cierre}</span> <img src={time} className='w-6 inline-block' alt=""/></p>
        </div>
